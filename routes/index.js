...
// Like Comment
router.post('/comment/:id/like', [functions.isAuthenticated], article.likeComment);

// Dislike Comment
router.post('/comment/:id/dislike', [functions.isAuthenticated], article.dislikeComment);
