...
const getSelectString = (selectStr, requiredId) => {
...
const populateResult = (storeWhere, arrayPop, match, result) => {
      ...
      results.forEach(function (result) {
        ...
        if (isArray) {
          result[opts.idField].map(function (resultId) {
            ...
            if (match)
              populateResult(opts.storeWhere, opts.arrayPop, match, result);
          });
